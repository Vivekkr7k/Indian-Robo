  ...
  <div className="intro-content">
    ...
    <div className="tubes-sizes">
      <div className="tube-card">
        ...
        <h3>48<span>×38×1000 mm (1 mm)</span></h3>
        <p>Precision builds — ultra-light yet strong.</p>
      </div>
      <div className="tube-card">
        ...
        <h3>40<span>×36×1000 mm (2 mm)</span></h3>
        <p>Heavy-duty projects — added strength, same low weight.</p>
      </div>
    </div>
    <p>
    ...
    <a href="#featured-products" className="btn-primary">Explore Our Tubes</a>
  </div>
</section>
